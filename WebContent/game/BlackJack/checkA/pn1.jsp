...
<html>
<head><title>A선택</title></head>
<body background="/Gamble/game/images/bg.png">
<center>
<b>첫번째 카드 'A'를 어떤 숫자로 사용하시겠습니까?</b><br><br>
<input type="button" value="   1   " name="choice1" onclick="location.href='choice1_1.jsp'" >&nbsp;&nbsp;&nbsp;
<input type="button" value="   11   " name="choice11" onclick="location.href='choice11_1.jsp'" >
</body>
</html>
